  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">        
          ...
          <div class="row form-group">
            <div class="col-sm-5 pr-0">              
              <input type="text" class="form-control" v-on:keyup.enter="extraer()" v-model="ruc_dni" placeholder="ruc o dni">            
            </div>
            ...
            <div class="col-sm-4">
              <select class="form-control" v-model="tipo" :disabled="estado_extraer">
          ...
          <div class="row form-group">
            <div class="col-sm-12">
              <input type="text" class="form-control" v-model="razon_nombre" placeholder="Razon social o Nombre" :disabled="estado_extraer">
            </div>            
          </div>
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" v-on:click="crear_cliente()">Crear Cliente</button>
