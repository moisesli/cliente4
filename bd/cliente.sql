...
--
-- Servidor: localhost
-- Tiempo de generación: 03-03-2019 a las 00:46:06
...
CREATE TABLE `producto` (
  ...
  `products_header_id` varchar(7) DEFAULT NULL,
...
INSERT INTO `producto` (`id`, `precio_con_igv`, `precio_sin_igv`, `unidad`, `moneda`, `medida`, `igv_tipo`, `local_id`, `categoria_id`, `products_header_id`, `producto_stock_id`, `dependiente`, `pro_ser`) VALUES
(1, '18.50', NULL, '1', 'PEN', 'g', '10', '3', '2', '1', '1', 'si', 'NIU'),
(2, '7.45', NULL, '100', 'PEN', 'g', '10', '3', '2', '2', '1', 'si', 'NIU'),
(3, '30.26', NULL, '500', 'PEN', 'g', '10', '3', '2', '3', '1', 'si', 'NIU');
